...
```bash
$ kubectl apply -f https://github.com/jetstack/cert-manager/releases/download/v1.2.0-alpha.1/cert-manager.crds.yaml
```
...
```console
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.2.0-alpha.1/cert-manager.crds.yaml
```
...
| `image.tag` | Image tag | `v1.2.0-alpha.1` |
...
| `webhook.image.tag` | Webhook image tag | `v1.2.0-alpha.1` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.2.0-alpha.1` |
